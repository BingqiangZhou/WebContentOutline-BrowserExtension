...
**Note**: This is a lightweight, open-source extension. Source code available on [GitHub](https://github.com/BingqiangZhou/WebContentOutline-BrowserExtension). Contributions welcome!
...
**注意**：这是一个轻量级开源扩展。源代码可在 [GitHub](https://github.com/BingqiangZhou/WebContentOutline-BrowserExtension) 上获取。欢迎贡献！
